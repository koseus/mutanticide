...
public class RSKMutation extends KeywordMutation{

	
	public RSKMutation(String name, String method){
		super(name, method);
	}
    ...
    public void RSK() throws IOException{
	    ...
	    File outDir = new File("out/RSK_" + methodToMutate + "/");
	    outDir.mkdirs();
