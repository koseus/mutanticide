...
public class ASTKMutation extends KeywordMutation {
	
	public ASTKMutation(String name, String method){
		super(name, method);
	}
    ...
    public void ASTK() throws IOException{
	    ...
	    File outDir = new File("out/ASTK_" + methodToMutate + "/");
	    outDir.mkdirs();
