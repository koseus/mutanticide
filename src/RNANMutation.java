...
public class RNANMutation {
	...
	public RNANMutation(String className, String methodName, int line){
	...
	public void RNAN() throws IOException{
		...
		for(int i = 0; i < insn.size(); i++){
			...
			if(currentInsn.getType() == 15){
				...
				if(lnn.line == lineToMutate){
					...
					// MethodInsnNode
					updatedInsn.add(new MethodInsnNode(INVOKEVIRTUAL, "java/lang/Object", "notify", "()V", false));
					i += 2;
					continue;
				}
			}
